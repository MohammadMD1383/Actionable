...
public class CustomAction1 extends AnAction {
	@Override
	public void actionPerformed(@NotNull AnActionEvent e) { mimActionPerformed(e, SettingsState.getInstance().customAction1, 1); }
}
