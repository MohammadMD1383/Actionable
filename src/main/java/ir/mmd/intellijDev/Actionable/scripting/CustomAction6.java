...
public class CustomAction6 extends AnAction {
	@Override
	public void actionPerformed(@NotNull AnActionEvent e) { mimActionPerformed(e, SettingsState.getInstance().customAction6, 6); }
}
