...
public class CustomAction2 extends AnAction {
	@Override
	public void actionPerformed(@NotNull AnActionEvent e) { mimActionPerformed(e, SettingsState.getInstance().customAction2, 2); }
}
