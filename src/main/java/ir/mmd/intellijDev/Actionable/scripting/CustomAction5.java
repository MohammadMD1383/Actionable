...
public class CustomAction5 extends AnAction {
	@Override
	public void actionPerformed(@NotNull AnActionEvent e) { mimActionPerformed(e, SettingsState.getInstance().customAction5, 5); }
}
